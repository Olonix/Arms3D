...
def process_skeletons():
    ...
    """
    INPUT_JSON_DIR = "primary_skeletons"
    OUTPUT_JSON_DIR = "smoothed_skeletons"
    OUTPUT_3D_DIR = "smoothed_3d_vis"
    ...
    for i, json_file in enumerate(json_files):
        ...
        # vis_path = os.path.join(OUTPUT_3D_DIR, json_file.replace(".json", "_smoothed"))
        # visualize_3d_as_plt(smoothed_skeleton, vis_path)
